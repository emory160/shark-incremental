...
LANGUAGES.ZH = {
    ...
    text: {
		...
		'all-research': {
            ...
            'tr1': ['全能鲨之力折算', `每升一级，“全能鲨之力”的折算延迟 <b>+15</b>.`],
            'tr2': ['敏捷全能鲨之友', `“敏捷全能鲨”的效果以 10% 的比例提升“强化全能鲨之力”和“全能鲨超越”的底数。`],
            'tr3': ['超越强化', `小幅提升获得${toTextStyle("超越",'transcend')}碎片的公式。`],
            'tr4': ['强化超越压缩器', `小幅提升压缩的${toTextStyle("超越",'transcend')}碎片数量。`],
